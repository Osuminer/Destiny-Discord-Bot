...
class API:
    ...
    def _get_request_token(self, url, access_token):
        headers = {'X-API-Key': self._apiKey,
    ...
    def get_destiny_entity_definition(self, entity_type, hash_identifier):
    ...
    def get_vendor(self, membership_type, membership_id, character_id, vendorHash, access_token, components):
        ...
        return self._get_request_token(url, access_token)

    def get_vendors(self, components):

        url = DESTINY2_URL + 'Vendors/?components={}'
